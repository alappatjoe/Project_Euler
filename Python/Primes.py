...
# has global list primes that 

import Timer

primes = [2, 3]

# loads prime numbers from a .txt file
...
# function to generate primes up to a given value
...
# recursive function to generate primes 
...
# generates a certain number of primes
...
# writes current prime list to a .txt file
...
# manual check if a number is prime, does not check if it is in the prime list
def isPrime(num):
    global primes
